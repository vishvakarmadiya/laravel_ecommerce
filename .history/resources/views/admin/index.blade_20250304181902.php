            ...
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-9">
                      <div class="d-flex align-items-center align-self-start">
                        <h3 class="mb-0">
                          @if(isset($orders_count_today))
                          {{ $orders_count_today }}
                          @endif
                        </h3>
                        <p class="text-success ml-2 mb-0 font-weight-medium">+{{ $orders_count_today_pr = $orders_count > 0 ? ($orders_count_today / $orders_count) * 100 : 0;}}%</p>
                      </div>
                    </div>
                    <div class="col-3">
                  ...
                  <h6 class="text-muted font-weight-normal">Today Product Sell</h6>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-9">
                      <div class="d-flex align-items-center align-self-start">
                        <h3 class="mb-0">
                          @if(isset($total_sell_today))
                          {{ $total_sell_today }}
                          @endif
                        </h3>
                        <p class="text-success ml-2 mb-0 font-weight-medium">+{{ $sell_pr_today = $total_sell_today > 0 ? ($total_sell_today / $total_sell) * 100 : 0;}}%</p>
                      </div>
                    </div>
                    <div class="col-3">
                      <div class="icon icon-box-success ">
                  ...
                  <h6 class="text-muted font-weight-normal">Today Total Income </h6>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h6 class="text-muted font-weight-normal">Totle Product Sell</h6>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h6 class="text-muted font-weight-normal">Total Sell Income </h6>
                </div>
              </div>
            </div>
          </div>
