<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
    <a class="sidebar-brand" ><img src="{{ asset('admin/assets/images/logo.png') }}" height="50px" width="50px" alt="logo" />
    </a>
    <a class="sidebar-brand brand-logo-mini" href="../../index.html"><img src="{{ asset('admin/assets/images/logo.png') }}" alt="logo" /></a>
  </div>
  <ul class="nav">
