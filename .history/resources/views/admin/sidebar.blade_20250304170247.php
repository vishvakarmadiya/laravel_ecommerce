<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
    <a class="sidebar-brand" >Davisweety
    </a>
    <a class="sidebar-brand brand-logo-mini" href="#"><img src="{{ asset('admin/assets/images/logo.png') }}" alt="logo" /></a>
  </div>
  <ul class="nav">
    <li class="nav-item profile">
      <div class="profile-desc">
        <div class="profile-pic">
          ...
          <img class="img-xs rounded-circle" src="{{ asset('admin/assets/images/logo.png') }}" alt="User Image">
            <span class="count bg-success"></span>
          </div>
          <div class="profile-name">
            <h5 class="mb-0 font-weight-normal">Davis Vishvakarma</h5>
            <span>Admin</span>
          </div>
        </div>
