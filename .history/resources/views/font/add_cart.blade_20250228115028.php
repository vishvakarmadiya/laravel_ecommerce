        ...
        <div class="col-md-6">
            <div class="cart-summary">
                <div class="cart-content">
                    ...
                    <h4>Grand Total <span>${{ getCart()->sum(fn($item) => $item->price * $item->quantity) + 50}}</span></h4>
                </div>
                ...
                <div class="cart-btn mt-3">
                    ...
                    <button class="btn text-white"><a href="{{route('shipingAddrase') }}" class="text-white">Proceed to Checkout</a></button>
