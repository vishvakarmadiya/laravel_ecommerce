        ...
        <form action="#" method="POST">
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <!-- Shipping Address -->
                    <div class="shipping-address d-none">
                ...
                <div class="col-md-5">
                    ...
                    <div class="checkout-payment">
                        ...
                        <div class="payment-methods">
                            <div class="form-check">
                                <input type="radio" class="form-check-input" id="payment-1" name="payment">
                                <label class="form-check-label" for="payment-1">Paypal</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" id="payment-2" name="payment">
                                <label class="form-check-label" for="payment-2">Payoneer</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" id="payment-3" name="payment">
                                <label class="form-check-label" for="payment-3">Check Payment</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" id="payment-4" name="payment">
                                <label class="form-check-label" for="payment-4">Direct Bank Transfer</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" id="payment-5" name="payment">
                                <label class="form-check-label" for="payment-5">Cash on Delivery</label>
                            </div>
                        </div>
...
<!-- JavaScript to Toggle Shipping Address -->
<script>
    document.getElementById('shipto').addEventListener('change', function () {
        document.querySelector('.shipping-address').classList.toggle('d-none', !this.checked);
    });
</script>
