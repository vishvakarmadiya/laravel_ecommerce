                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav m-auto">
                            <a href="fontend/index.html" class="nav-item nav-link active">Home</a>
                            <a href="{{ route('products_listing') }}" class="nav-item nav-link">Products</a>
                            <div class="nav-item dropdown">
                                <a href="fontend/#" class="nav-link dropdown-toggle" data-toggle="dropdown">Pages</a>
                                <div class="dropdown-menu">
                                    ...
                                    <a href="fontend/cart.html" class="dropdown-item">Cart</a>
                                    <a href="fontend/wishlist.html" class="dropdown-item">Wishlist</a>
                                    <a href="fontend/checkout.html" class="dropdown-item">Checkout</a>
