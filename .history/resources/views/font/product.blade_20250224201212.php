                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-8">
                                <!-- Search Bar -->
                                <form action="{{ route('products_listing') }}" method="GET">
                                ...
                                <div class="product-short">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="{{ route('products_listing', ['sort' => 'low']) }}" class="dropdown-item">Price (Low to High)</a>
                                            <a href="{{ route('products_listing', ['sort' => 'high']) }}" class="dropdown-item">Price (High to Low)</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="product-item">
                            <div class="product-image">
                                <a href="{{ route('product_ditails', $products->id) }}">
            ...
            <div class="col-md-3">
                <div class="sidebar-widget category">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('products_listing', ['category' => $categories->name]) }}">{{ $categories->name }}</a><span></span></li>
                        @endforeach
                        @endif
                    </ul>
                </div>
                ...
                <div class="sidebar-widget image">
                    ...
                    <a href="">
                        <img src="{{ asset('frontend/img/category-1.jpg') }}" alt="Image">
                    </a>
                </div>
