            ...
            <div class="col-md-8">
                ...
                <div class="billing-address">
                    ...
                    <form action="{{ route('orderAddress') }}" method="POST">
                        @csrf
                        <div class="row">
                            @if (getUserOrdersAddress()->count() > 0)
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" name="billing_mobile"
                                    value="{{ old('billing_mobile',$address->mobile) }}" placeholder="Mobile No">
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control" type="text" name="billing_address"
                                    value="{{ old('billing_address',$address->address) }}" placeholder="Address">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" name="billing_city"
                                    value="{{ old('billing_city',$address->city) }}" placeholder="City">
                                @error('billing_city')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" name="billing_state"
                                    value="{{ old('billing_state',$address->state) }}" placeholder="State">
                                @error('billing_state')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" name="billing_zip"
                                    value="{{ old('billing_zip', $address->pin_code) }}" placeholder="ZIP Code">
                                @error('billing_zip')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
