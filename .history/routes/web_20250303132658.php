...
Route::get('/password/forget', [ForgaetPasswordController::class, 'forgetPasswordshow'])->name('forgetPasswordshow');
Route::post('/password/reset', [ForgaetPasswordController::class, 'forgetPassword'])->name('forgetPassword');
Route::get('/reset-password/{token}', [ForgaetPasswordController::class, 'showResetForm'])->name('showResetForm');
Route::get('/reset-password/{token}', [ForgaetPasswordController::class, 'showResetForm'])->name('password.reset');
