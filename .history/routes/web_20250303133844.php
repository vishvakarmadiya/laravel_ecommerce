...
Route::get('/forgot-password', [ForgotPasswordController::class, 'forgetPasswordShow'])->name('password.request');
Route::post('/forgot-password', [ForgotPasswordController::class, 'forgetPassword'])->name('password.email');
