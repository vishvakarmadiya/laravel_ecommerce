...
Route::get('/forgot-password', [ForgaetPasswordController ::class, 'forgetPasswordShow'])->name('password.request');
Route::post('/forgot-password', [ForgaetPasswordController ::class, 'forgetPassword'])->name('password.email');
Route::get('/reset-password', [ForgaetPasswordController ::class, 'showResetForm'])->name('password.reset');
Route::post('/reset-password', [ForgaetPasswordController ::class, 'resetPassword'])->name('password.update');
