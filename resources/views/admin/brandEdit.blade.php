                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Form for Updateing Brand -->
                                    <form action="{{ route('brand_update', $brand->id ?? '') }}" method="post" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control w-100 text-dark" style="height: 50px; background:beige;" id="brandName" name="name" placeholder="Enter Brand Name" value="{{ old('name',$brand->name) }}" required>
                                            @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="image" class="form-control dropify text-dark"
                                                data-default-file="{{ asset('images/brands/' . $brand->image) }}">
                                            @error('logo')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>

                                        <button type="submit" class="btn btn-primary w-100" style="height: 50px;">Update Brand</button>
                                    </form>
                                </div>
                            </div>
                        </div>
