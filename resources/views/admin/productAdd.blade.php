                ...
                <div class="card-body">
                  ...
                  <form action="{{route('productstore')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control bg-white text-dark w-100" style="height: 50px;" id="productName" name="name" placeholder="Enter Product Name" value="{{ old('name') }}" required>
                      @error('name')
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control bg-white text-dark" id="productDescription" name="description" rows="6" placeholder="Enter Product Description">{{ old('description') }}</textarea>
                      @error('description')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
                    </div>
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control bg-white text-dark w-100" style="height: 50px;" id="mrp" name="mrp" placeholder="Enter Maximum Retail Price" value="{{ old('mrp') }}" required>
                      @error('mrp')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control bg-white text-dark w-100" style="height: 50px;" id="productPrice" name="price" placeholder="Enter Product Price" value="{{ old('price') }}" required>
                      @error('price')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="image" class="form-control dropify text-dark bg-white text-dark">
                      @error('image')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
                    </div>

                    <button type="submit" class="btn btn-primary w-100" style="height: 50px;">Add Product</button>
                  </form>
