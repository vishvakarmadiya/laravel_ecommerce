  ...
  <div class="container-scroller">
    ...
    <form action="{{route('subcategoryStore')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input style="height: 50px;" type="text" class="form-control  bg-white text-dark  w-100" id="subcategoryName" name="name" placeholder="Enter Subcategory Name" value="{{ old('name') }}" required>
            @error('name')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control  bg-white text-dark" id="subcategoryDescription" name="description" rows="6" placeholder="Enter Subcategory Description">{{ old('description') }}</textarea>
            @error('description')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
